<?php
     function my_function_name(){
        ...
        wp_enqueue_script( 'fancybox-media-js',  get_template_directory_uri() . '/js/jquery.fancybox-media.js', array('jquery'), '2.1.4', true );
        ...
        wp_enqueue_script( 'setting-js',  get_template_directory_uri() . '/js/portfolio/setting.js', array('jquery'), '1.2.2', true );
